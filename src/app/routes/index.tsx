...
import { ArticlePage, FavoritesPage, HomePage, LazyBlogPage, LazyBreweriesPage, LazyProductsPage, LazyRegisterPage, ProductDetailsPage, ProfilePage } from '@pages/index';
