...
// Обновить комментарий оптимистично
...
// Преобразовать данные с сервера в массив OptimisticComment
...
// Проверка, нужно ли переходить на предыдущую страницу
